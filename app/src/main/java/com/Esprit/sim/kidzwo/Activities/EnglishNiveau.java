...
public class EnglishNiveau extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_niveau);
        ...
        score.setText("Score: "+ User.scoreenglish);
    ...
    private void init() {
        ...
        rep1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    if(User.scoreenglish < 30 && extras.getString("niveau").equals("Niveau1"))
                    {
                        User.scoreenglish+=5;
                        score.setText("Score: "+ User.scoreenglish);

                        updateScore(User.id,User.scoreenglish);
                        verifScore();
                    }
                    else if(User.scoreenglish < 60 && extras.getString("niveau").equals("Niveau2"))
                    {
                        User.scoreenglish+=5;
                        score.setText("Score: "+ User.scoreenglish);
                    ...
                    else if(User.scoreenglish < 90 && extras.getString("niveau").equals("Niveau3"))
                    {
                        User.scoreenglish+=5;
                        score.setText("Score: "+ User.scoreenglish);
        ...
        rep2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(rep2.getText().equals(Repppv))
                {
                    ...
                    else if(User.scoreenglish < 120 && extras.getString("niveau").equals("Niveau4"))
                    {
                        User.scoreenglish+=5;
                        score.setText("Score: "+ User.scoreenglish);
    ...
    public void suivant(final TextView enonce, final Button rep1, final Button rep2, final Button rep3, final Button rep4){
        ...
        {
            Intent retour = new Intent(EnglishNiveau.this,English.class);
            retour.putExtra("cat","English");
    ...
    public void MyCustomAlertDialog(){
        final Dialog MyDialog = new Dialog(EnglishNiveau.this);
